...
try {
  ...
  if (!checks.includes("202607160001") || checks.filter((value) => value === "[]").length < 4) throw new Error("restored_contract_mismatch");
  console.log(JSON.stringify({ backup: "created", contractChecks: "passed", database: "temporary", migrationHead: "202607160001", restore: "passed" }, null, 2));
} catch (error) {

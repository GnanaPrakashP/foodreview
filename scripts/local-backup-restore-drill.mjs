...
try {
  ...
  if (!checks.includes("202607130010") || checks.filter((value) => value === "[]").length < 4) throw new Error("restored_contract_mismatch");
  console.log(JSON.stringify({ backup: "created", contractChecks: "passed", database: "temporary", migrationHead: "202607130010", restore: "passed" }, null, 2));
} catch (error) {

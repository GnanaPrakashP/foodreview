...
- Identity/environment: Witoh is canonical across app, legal and public support surfaces; development, preview and production use distinct IDs/schemes and EAS environments; production config fails closed and exposes no server/worker/scheduler credential.
...
file exists for Witoh in the workspace, and the installed development APK

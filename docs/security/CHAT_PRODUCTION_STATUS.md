...
- Runtime safety: production auth/recovery callbacks are scheme/environment/nonce/expiry bound; OTA is disabled; owner-scoped durable post drafts join logout/switch/deletion cleanup; private caches remain excluded from backup.

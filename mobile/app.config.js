...
function validateClientConfiguration(env = process.env, extra = {}) {
  ...
  const releaseDevCredential = releaseBuild && DEV_AUTOLOGIN_NAMES.find((name) => Boolean(env[name]));
  ...
  if (environment === "production") {
    ...
    parsedPublicHttpsUrl(env.EXPO_PUBLIC_WEB_BASE_URL, "EXPO_PUBLIC_WEB_BASE_URL");

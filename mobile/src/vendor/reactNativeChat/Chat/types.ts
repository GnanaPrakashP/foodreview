...
export interface ChatProps<TMessage extends IMessage> extends Partial<Omit<MessagesContainerProps<TMessage>, 'messageReplyContainerStyle'>> {
  ...
  /* Message bubble wrapper styles */
  wrapperStyle?: BubbleProps<TMessage>['wrapperStyle']
  ...
  /* Custom delivery ticks/status inside a message */
  renderTicks?: BubbleProps<TMessage>['renderTicks']
